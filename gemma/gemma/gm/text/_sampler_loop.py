...
from kauldron.typing import PRNGKey  # pylint: disable=g-multiple-import,g-importing-member
from kauldron.typing import check_type  # pylint: disable=g-multiple-import,g-importing-member
...
class SamplingState:
  ...
  def attention_mask_for_step(self) -> Bool["B cache_length"]:
    ...
    return self.full_attention_mask * step_mask
...
def _mask_full_attention_mask_prefix_for_next_turn(
  ...
  return full_attention_mask * mask
