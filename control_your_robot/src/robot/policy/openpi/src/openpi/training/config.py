...
_CONFIGS = [
    ...
    TrainConfig(
        name="toy_419_all_positive_infer",
        project_name="pistar",
    ...
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            assets=AssetsConfig(asset_id="white_plug_100_200"),
            base_config=DataConfig(
                prompt_from_task=True,
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/public/home/wangsenbao221/SothisAI/openpi/checkpoints/pi05_base/params"
        ),
    ),
    TrainConfig(
        name="pi05_star_toy_330",
        project_name="pistar",
        model=pi0_config.Pi0Config(pi05=True, pistar=True, action_horizon=10, discrete_state_input=False),
        data=LeRobotLiberoDataConfig(
            repo_id="toy_330_pistar_all_positive",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
            adv_ind_dropout=False,
        ),
