...
Usage:
    ...
    Example (LIBERO-Spatial):
        python examples/libero/regenerate_libero_dataset.py \
            ...
            --libero_raw_data_dir /public/home/chenyuyao1/dataset/LIBERO/libero_spatial \
            --libero_target_dir /public/home/chenyuyao1/dataset/LIBERO_no_noops/libero_spatial_no_noops
...
def main(args):
    ...
    metainfo_json_dict = {}
    metainfo_json_out_path = f"./examples/libero/{args.libero_task_suite}_metainfo.json"
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for i in range(len(orig_data.keys())):
            ...
            # At end of episode, save replayed trajectories to new HDF5 files
            # (keep both successful and failed episodes).
            if len(actions) == 0:
                print(f"\tSkipping empty episode demo_{i} after no-op filtering")
            else:
