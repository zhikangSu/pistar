...
class C_STD_CAN():
    ...
    def JudgeCanInfo(self):
        ...
        if isinstance(actual_bitrate, tuple):
            print(f"[WARNING] Could not verify bitrate for {self.channel_name}. Assuming it is correct.")
        elif self.expected_bitrate is not None and not (actual_bitrate == self.expected_bitrate):
